...
Архива съдържа проект за Уеб покани и генериране на МЕМЕ създаден от Александър Стоилов, Ангел Марински и Айше Джинджи. Съдържа 4 основни директории backend(прави връзката между frontend и базата данни), config(съдържа конфигурациите на системата), database(създаваме базите и seed-ове), frontend(грижи се за UI на системата, както и за error handling).
